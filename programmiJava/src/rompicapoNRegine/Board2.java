...
public class Board2 {
	...
	private int queens;
	private int[] rowAttack; // mi chiedo se una certa riga � sottoscacco
	private int[] colAttack; // mi chiedo se una certa colonna � sottoscacco
	private int[] dg1Attack; // mi chiedo se la diagonale in basso a destra � sottoscacco
	private int[] dg2Attack; // mi chiedo se la diagonale in alto a destra � sottoscacco
