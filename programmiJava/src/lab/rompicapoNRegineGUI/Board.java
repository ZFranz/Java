...
public class Board {
	 ...
	 */
	private Board(int n, int q, SList<Integer> row, SList<Integer> col, SList<Integer> dg1, SList<Integer> dg2,
			String c) {
		this.size = n;
		this.queens = q;
	...
	public boolean underAttack(int i, int j) {
		return this.queensAttackingRow.belong(i) || this.queensAttackingCol.belong(j)
				|| this.queensAttackingDg1.belong(i - j) || this.queensAttackingDg2.belong(i + j);
	}
